...
// Main component
const ScriptsWheelFixed = () => {
    const [currentIndex, setCurrentIndex] = useState(0);
    
    // Function to generate absolute URLs for scripts
    const getScriptUrl = (filename) => {
        return `https://david9930.github.io/living-with-the-ghost-of-sam/scripts/${filename}`;
    };
            ...
            <div style={{ textAlign: 'center' }}>
                ...
                <div className="flex gap-4 justify-center">
                    {episode.available ? (
                        <>
                            <a 
                                href={getScriptUrl(episode.filename)}
                                style={{
                                    display: 'flex',
                                    alignItems: 'center',
                                    gap: '0.5rem',
...
export default ScriptsWheelFixed;
